# USAGE
# python extract_embeddings.py --dataset dataset/face_detection
# --embeddings resources/face_detection_output/embeddings.pickle
# --detector resources/face_detection_model
# --embedding-model resources/face_embedding_model/openface_nn4.small2.v1.t7
...
ap.add_argument("-i", "--dataset", default="dataset/face_detection",
